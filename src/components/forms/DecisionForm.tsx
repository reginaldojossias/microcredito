  ...
  return (
    <Card>
      ...
      <textarea
        ...
        className="mt-5 min-h-[120px] w-full rounded-xl border border-[#E5E5E5] px-4 py-3 text-[14px] outline-none focus:border-[#111]"
      />
      ...
      {message ? <p className="mt-4 text-[13px] text-[#666]">{message}</p> : null}
    </Card>
  );
}
